...
enum LinuxDistribution: String, Codable, CaseIterable, Identifiable {
    ...
    var recommendedISO: String {
        ...
        case .debian:
            return "https://cdimage.debian.org/debian-cd/current/arm64/iso-cd/debian-12.x.x-arm64-netinst.iso"
        case .arch:
            return "https://geo.archlinux.org/iso/2024.01.01/archlinux-2024.01.01-x86_64.iso"
        case .fedora:
            return "https://download.fedoraproject.org/pub/fedora/linux/releases/40/Server/aarch64/iso/Fedora-Server-40-1.14-aarch64.iso"
        case .centos:
            return "https://mirrors.centos.org/mirrorlist?path=/9-stream/isos/aarch64/&release=9&arch=aarch64"
        case .alma:
            return "https://repo.almalinux.org/almalinux/9.x/isos/aarch64/AlmaLinux-9.x-aarch64-minimal.iso"
        case .rocky:
            return "https://download.rockylinux.org/pub/rocky/9.x/isos/aarch64/Rocky-9.x-aarch64-minimal.iso"
        case .other:
            return ""
        }
    }
